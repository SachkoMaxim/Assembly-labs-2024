...
include \masm32\include\masm32rt.inc ; MessageBox, FloatToStr, wsprintf, LoadLibrary, GetProcAddress, FreeLibrary, ExitProcess 
...
SachkoAeolus_LoopingCalculation macro
	...
	invoke LoadLibrary, offset SachkoLeto_TheNameOfMyLib
	mov SachkoChaos_MyOwnLibrary, eax
	
	invoke GetProcAddress, SachkoChaos_MyOwnLibrary, offset SachkoKraken_NameOfMyLibProcedure
    mov SachkoNike_CalculationProcedureLib, eax
	...
	.repeat
		SachkoNotus_EternalCalculation:
			...
			mov esi, SachkoUrania_ResultForLibrary 
			push esi
			
			
			lea esi, SachkoEuterpe_DnumbersArray[edi * 8]
			push esi
			
			lea esi, SachkoClio_CnumbersArray[edi * 8]
			push esi
			
			lea esi, SachkoChronos_NumberTwoForFormula
			push esi
			...
			lea esi, SachkoPolyhymnia_AnumbersArray[edi * 8]
			push esi
			
			
			
			lea esi, SachkoCalliope_BnumbersArray[edi * 8]
			push esi


			call [SachkoNike_CalculationProcedureLib]
		...
		SachkoZephyrus_EndOfEternalLoop: 
			invoke FreeLibrary, SachkoChaos_MyOwnLibrary
...
.data?
	...
	SachkoNike_CalculationProcedureLib dd ?
    SachkoChaos_MyOwnLibrary dd ?
...
.data
	...
	SachkoKraken_NameOfMyLibProcedure db "SachkoNike_CalculationProcedureLib", 0
    SachkoLeto_TheNameOfMyLib db "8-20-IM-22-Sachko-library.dll", 0
