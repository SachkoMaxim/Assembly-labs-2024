...
.data
	...
	SachkoMinos_UseLEssWinDowHeADer db "You entered the Underworld (Lab 4) (ENC INC)",0
	...
	SachkoOrm_wRongVeryWROngPAasSSworDHeADer db "WRONG, very wrong PASSWORD (ENC INC)",0
	...
	SachkoEurydice_LeaVingMessenGEwiNDOWHeadER db "It was nice to know you. BYE (ENC INC)",0
	...
	SachkoHecate_OpenAfterALLinfRMationHeaDEER db "Personal data of Maksym Sachko from the IM-22 group (option 20) #ENC INC#",0
	...
	SachkoAlecto_passwordWrITewiNDowText db "Write the PAssWord to ENTER (not here) (ENC INC)",0
...
SachkoFourthLabStillUnderworldButMoreCooler:
	...
	SachkoTemp:
		Dialog "Write the PAssWord to ENTER (ENC INC)", "Comic Sans MS", 9, WS_OVERLAPPED or WS_SYSMENU or DS_CENTER, 8, 216, 811, 240, 145, 1024
